...
export default function Home(){
 ...
 return <main>
  <header className="topbar"><a className="brand" href="#top"><span className="brand-mark"><HeartPulse size={20}/></span>Medi<span>Locker</span></a><div className="privacy-pill"><LockKeyhole size={15}/> Values are not stored</div></header>
  <section className="hero" id="top"><div className="orb orb-one"/><div className="orb orb-two"/><div className="hero-spark spark-one">✦</div><div className="hero-spark spark-two">✚</div><div className="hero-inner"><div className="eyebrow"><Sparkles size={15}/> Your health data, made friendlier</div><h1>Unlock a clearer view<br/><span>of your health.</span></h1><p>Pick a health check, add values from your clinician or lab report, and let MediLocker turn them into an easy-to-read educational estimate. Quick, private, and judgment-free.</p><div className="hero-chips"><span>⚡ Fast estimates</span><span>🔒 Nothing stored</span><span>✨ Four health checks</span></div></div></section>
